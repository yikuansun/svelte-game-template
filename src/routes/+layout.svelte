<script>
    ...
    let TRANSITION_DURATION = 500; // in milliseconds
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {screenWidth} {screenHeight}"
    ...
    <!-- put a rectangle behind the content to set the background color -->
    <rect width={screenWidth} height={screenHeight} x="0" y="0" fill="aliceblue" />
...
<style>
    ...
    /** TODO: add your own global styles here */
</style>